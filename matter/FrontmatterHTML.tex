...
{\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north west,inner sep=0pt] at (0,0) {\includegraphics[width=\paperwidth]{\chaptergraphicspath background.pdf}}; % Background image
...
\noindent \textsc{Partially funded by the National Science Foundation, grants DMR-1904629 and DMR-2203378}\\ 
...
\node at (current page.north west)
{\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north west,inner sep=0pt] at (0,0) {\includegraphics[width=\paperwidth]{\chaptergraphicspath TOCheader.pdf}};
