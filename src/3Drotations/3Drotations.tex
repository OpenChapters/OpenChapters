...
\begin{multicols}{2}
\begin{itemize}
    \item[{\color{OCBurntOrange}\ref{\chabbr:passive3D}:}] Learn how to represent 3D passive rotations by matrices
    \item[{\color{OCBurntOrange}\ref{\chabbr:eulerangles}:}] Define the Euler angle representation
    \item[{\color{OCBurntOrange}\ref{\chabbr:neoEulerian}:}] Going beyond the Eulerian description 
    \item[{\color{OCBurntOrange}\ref{\chabbr:othernumbers}:}] 
\end{itemize}
\end{multicols}}}
% ###################################################################
% ###################################################################
...
\section{Passive 3D Rotation Matrices}\label{\chabbr:passive3D}
...
\subsection{Single rotations}\label{\chabbr:single3Drotationmatrices}
...
\subsection{3D rotation composition}\label{\chabbr:3Drotationcomposition}
...
\section{Euler Angles and their Properties}\label{\chabbr:eulerangles}
...
\begin{equation}
	\mathbf{e}'_i = R_z(\varphi_1)_{ij} \mathbf{e}_j \rightarrow \begin{pmatrix}\mathbf{e}'_x\\ \mathbf{e}'_y\\ \mathbf{e}'_z\end{pmatrix} = 
	\begin{pmatrix}\cos\varphi_1&\sin\varphi_1&0\\ -\sin\varphi_1&\cos\varphi_1&0\\ 0&0&1\end{pmatrix}
	\begin{pmatrix}\mathbf{e}_x\\ \mathbf{e}_y\\ \mathbf{e}_z\end{pmatrix}\ . 
\end{equation}
...
\begin{equation}
	\mathbf{e}''_i = R_x(\Phi)_{ij} \mathbf{e}'_j \rightarrow \begin{pmatrix}\mathbf{e}''_x\\ \mathbf{e}''_y\\ \mathbf{e}''_z\end{pmatrix} = 
...
\begin{equation}
	\mathbf{e}'''_i = R_z(\varphi_2)_{ij} \mathbf{e}''_j \rightarrow \begin{pmatrix}\mathbf{e}'''_x\\ \mathbf{e}'''_y\\ \mathbf{e}'''_z\end{pmatrix} = 
...
{\small\begin{equation}
	...
	s_1s&-c_1s&c\end{pmatrix}\ .\label{eq:eulermatrix}
\end{equation}}
...
\section{Neo-Eulerian Rotation Representations}\label{\chabbr:neoEulerian}
