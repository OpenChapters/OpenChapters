...
\chapter{Chapter Title}\label{\chabbr:ch:ChapterTitle} % should be the same as the filename (without extension)
...
\writeauthor{\chabbr:ch:ChapterTitle}{Chapter Title}{Last Name}{First Name}{Department}{Institution}{email}{full homepage URL}
