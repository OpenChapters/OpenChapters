...
\insertfigurew{figcomplex}{figcomplex}{(a) Graphical representation of two complex numbers; (b) 2D rotation by means of multiplication by a unit complex number.}{6.0in}
...
\subsection{2D Rotations and Unit Complex Numbers}\OClabel{complexrot}
...
\subsection{Split Number Systems}\OClabel{splitnumbers}
