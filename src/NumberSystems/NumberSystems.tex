...
\chapter{Number Systems}\label{\chabbr:NumberSystems}
...
\insertfigurew{figcomplex.eps}{figcomplex}{(a) Graphical representation of two complex numbers; (b) 2D rotation by means of multiplication by a unit complex number.}{6.0in}
...
\subsection{2D Rotations and Unit Complex Numbers}\label{\chabbr:complexrot}
...
\subsection{Euler's Formula, unit quaternions and their relation to 3D rotations}\label{\chabbr:EulerFormula}
...
\subsection{Split Number Systems}\label{\chabbr:splitnumbers}
