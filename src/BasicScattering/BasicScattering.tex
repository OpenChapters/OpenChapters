...
% ###################################################################
\chapter{Particle Scattering}\label{\chabbr:ch:ParticleScattering}

% Register author information (repeat for each co-author)
\writeauthor{\chabbr:ch:ParticleScattering}{Particle Scattering}{De Graef}{Marc}{Materials Science and Engineering}{Carnegie Mellon University}{mdg@andrew.cmu.edu}{https://www.mse.engineering.cmu.edu/directory/bios/degraef-marc.html}
...
\section{Scattering by Electrons and Neutrons}\label{\chabbr:sec:elecneutron}
