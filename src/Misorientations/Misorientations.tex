...
\renewcommand{\chabbr}{MISORI}
%     this will appear in a secondary header below the chapter title.

% All figures are stored in the src/Misorientations/eps folder and must be of the *.pdf type. 

\chapterimage{MISORIheader.pdf}
...
\chapter{Misorientations and Disorientations\label{\chabbr:ch:Misorientations}}
