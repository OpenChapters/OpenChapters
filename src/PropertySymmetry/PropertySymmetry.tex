...
\renewcommand{\chabbr}{PRPSYM}
%     this will appear in a secondary header below the chapter title.

% All figures are stored in the src/PropertySymmetry/eps folder and must be of the *.pdf type. 

\chapterimage{\graphicspath PRPSYMheader.pdf}
...
\chapter{Material Properties and Symmetry}\label{\chabbr:ch:PropertySymmetry}

% add the author information so that it will appear in the Author List at the start of the document
\writeauthor{PRPSYM:ch:PropertySymmetry}{Material Properties and  Symmetry}{De Graef}{Marc}{Materials Science and Engineering}{Carnegie Mellon University}{mdg@andrew.cmu.edu}{https://www.mse.engineering.cmu.edu/directory/bios/degraef-marc.html}

\begin{learningobjectives}
{\begin{itemize}
    \item[{\color{OCBurntOrange}\ref{\chabbr:sec:thermosym}:}] Learn about intrinsic symmetry
    \item[{\color{OCBurntOrange}\ref{\chabbr:sec:thermosym}:}] 
...
\end{align}
They can be derived quite easily by considering how each basis vector transforms under a rotation of $90^{\circ}$ around the $z$ axis, as described in section~\ref{\chabbr:ssec:vectortransformation}.
...
{\small\begin{align*}
	...
	\begin{bmatrix}xx&xy&xz\\ xy&yy&yz\\ xz&yz&zz\end{bmatrix}\begin{pmatrix}0&1&0\\ -1&0&0\\ 0&0&1\end{pmatrix} = 
	...
	\begin{bmatrix}xx&xy&xz\\ xy&yy&yz\\ xz&yz&zz\end{bmatrix}\begin{pmatrix}-1&0&0\\ 0&-1&0\\ 0&0&1\end{pmatrix} = 
	\left[\begin{array}{ccc} 
...
C_i\bm{\mu}\tilde{C}_i = \begin{pmatrix}-1&0&0\\ 0&-1&0\\ 0&0&-1\end{pmatrix}
	\begin{bmatrix}xx&xy&xz\\ xy&yy&yz\\ xz&yz&zz\end{bmatrix}\begin{pmatrix}-1&0&0\\ 0&-1&0\\ 0&0&-1\end{pmatrix} = 
	\begin{bmatrix}xx&xy&xz\\ xy&yy&yz\\ xz&yz&zz\end{bmatrix}.
\end{equation}}
