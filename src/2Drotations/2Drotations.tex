...
\chapter{2D Rotations}\label{\chabbr:2Drotations}
...
\begin{multicols}{2}
\begin{itemize}
    \item[{\color{OCBurntOrange}\ref{\chabbr:rotationmatrices}:}] Perform 2D passive and active rotations with matrices
    \item[{\color{OCBurntOrange}\ref{\chabbr:complex2D}:}] Use complex numbers for 2D rotations
    \item[{\color{OCBurntOrange}\ref{\chabbr:2Dcomposition}:}] Combine multiple rotations
    \item[{\color{OCBurntOrange}\ref{\chabbr:2Darbitrary}:}] Combine rotations with translations using homogeneous coordinates   
\end{itemize}
\end{multicols}}}
% ###################################################################
% ###################################################################
...
\subsection{Active 2D rotations}\label{\chabbr:2Dactive}
...
\subsection{Passive 2D rotations}\label{\chabbr:2Dpassive}
...
\section{Complex number representation}\label{\chabbr:complex2D}
...
\section{Composition of 2D rotations}\label{\chabbr:2Dcomposition}
...
\section{2D rotations combined with translations}\label{\chabbr:2Darbitrary}
