...
{\begin{itemize}
    ...
    \item[{\color{OCBurntOrange}\ref{\chabbr:sec:Lintrinsicsymmetry}:}] Formally describe their symmetry
    \item[{\color{OCBurntOrange}\ref{\chabbr:sec:Lprincipaleffects}:}] Introduce  principal and cross effects
    \item[{\color{OCBurntOrange}\ref{\chabbr:sec:galvano}:}] Discuss transport in a magnetic field
